    ...
    path(
        ...
        include(
            [
                ...
                path("popup/create/", create.PopupCreate.as_view(), name="popup_create"),
                path("create/", create.Create.as_view(), name="create"),
                path("popup/update/<int:pk>", update.PopupUpdate.as_view(), name="popup_update"),
                path("update/<int:pk>", update.Update.as_view(), name="update"),
                path("popup/delete/<int:pk>", delete.PopupUpDelete.as_view(), name="popup_delete"),
